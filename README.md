...
| **F-4E Phantom II** (双発・複座) | 機首ソリッドレドーム + IRSTフェアリング、側面インテーク (可変ランプ/スプリッター/白内壁)、ドッグトゥース付き上反外翼、強アンヒドラル水平尾翼、双発アフターバーナー、タンデム複座 (Pilot + WSO + HUD/ミラー)、**SEA迷彩塗装 (3色)**、**AIM-7/AIM-9 ミサイル + 増槽**、パネルライン/航法灯 |
